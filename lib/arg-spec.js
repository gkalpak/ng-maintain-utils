...
class ArgSpec extends AbstractValidatable{
  ...
  constructor(key, validator, errorCode, defaultValue) {
    ...
    this.defaultValue = (defaultValue || (defaultValue === false)) ? defaultValue : null;
  ...
  _validateFields() {
    ...
    let defaultValueType = typeof this.defaultValue;
    if (this.defaultValue && (defaultValueType !== 'boolean') && (defaultValueType !== 'string')) {
